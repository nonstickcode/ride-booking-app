    ...
    >
      ...
      >
        ...
        <div className="space-y-6 overflow-y-auto text-sm p-4">
          {/* Introduction */}
          <p>
            Welcome to <strong>RydeBlk</strong>. This Privacy Policy explains how we collect, use, 
            and protect your personal information when using our app and services.
          </p>
          ...
          <ul className="list-inside list-disc pl-4 space-y-1">
            ...
            <li>Basic profile information (e.g., name) provided by Google OAuth</li>
            <li>Usage data, including IP address, device details, and session activity</li>
          </ul>
          ...
          <p>
            Your data is stored securely using encryption methods. We use trusted third-party services, such 
            as <strong>Supabase</strong>, to ensure data privacy and protection. Access to your data is 
          ...
          <p>
            Your personal data is <strong>never sold</strong> or shared with unauthorized third parties. 
            It is only used for essential app functionalities, such as user authentication and booking rides.
          </p>

          {/* Third-Party Services */}
          <h3 className="text-lg font-semibold">Third-Party Services</h3>
          <p>
            We rely on third-party providers like <strong>Supabase</strong> for authentication and 
            secure data storage. Additionally, we may use <strong>Google Maps</strong> APIs for route 
            calculations and location-based services.
          </p>

          {/* Data Retention */}
          <h3 className="text-lg font-semibold">Data Retention</h3>
          <p>
            Your data is retained only as long as necessary to fulfill the purposes outlined in this 
            Privacy Policy. Once no longer needed, it will be securely deleted or anonymized.
          </p>
          ...
          <p>
            We use cookies to enhance user experience, analyze traffic, and improve app performance. 
